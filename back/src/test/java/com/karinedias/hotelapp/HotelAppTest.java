...
class HotelAppTest {
    ...
    void shouldDetectOverlapWhenAddingNewReservation() throws ParseException {
        ...
        // Wanted Reservation
        Reservation wantedReservation = buildReservation(1, 100, "2021-10-09", "2021-10-20");

        // Existing reservations
        Reservation existingReservation = buildReservation(1, 100, "2021-10-08", "2021-10-15");

        given(repository.findAll()).willReturn(Collections.singletonList(existingReservation));
    ...
    void shouldNotDetectFalseOverlapWhenAddingNewReservation() throws ParseException {
        ...
        // Existing reservations
        Reservation existingReservation = buildReservation(1, 100, "2021-10-05", "2021-10-08");
