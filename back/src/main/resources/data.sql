...
INSERT IGNORE INTO `client`  (`id`, `nom_complet`, `telephone`, `email`, `adresse`) VALUES
...
INSERT IGNORE INTO `hotel` (`id`, `nom`, `etoiles`, `adresse`, `telephone`, `email`, `ville`) VALUES
...
INSERT IGNORE INTO `reservation` (`id`, `client`, `hotel`, `date_debut`, `date_fin`, `num_chambre`) VALUES
